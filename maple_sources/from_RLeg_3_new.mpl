...
Jac[10,7..12] := J_Torso_from_RL[5,1..6]:    # constraint only for the orientation around y
...
fname := makeproc(out,[q::array(1..n), RL::array(1..linalg:-vectdim(RL)), LL::array(1..linalg:-vectdim(LL)), CoM::array(1..linalg:-vectdim(CoM)), Rot::array(1..linalg:-vectdim(Rot))]):
